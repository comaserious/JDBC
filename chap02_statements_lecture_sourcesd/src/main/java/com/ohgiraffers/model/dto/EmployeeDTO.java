...
*  하나로 묶어 전송하는 쓰임의 클래스
*  유사한 말로 VO(value object) , Bean ,Entity,(DO,Domain,Row)  등등 많이 불리운다
*  그중 DTO 와 VO 를 가장 많이 사용한다*/
...
*   4. toString Overriding 을 이용한 필드값 반환용 메소드*/
public class EmployeeDTO {
    ...
    private java.sql.Date hireDate;    // Date 클래스중 풀클래스가 java.sql 인 것으로 한다
